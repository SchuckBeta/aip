 ...
 */
@MyBatisDao
public interface GenTgroupDao extends CrudDao<GenTgroup> {
    /**
     * 批量新增.
     * @param entitys
     */
    public void insertPL(@Param("entitys") List<GenTgroup> entitys);

    /**
     * 批量修改.
     * @param entitys
     */
    public void updatePL(@Param("entitys") List<GenTgroup> entitys);
