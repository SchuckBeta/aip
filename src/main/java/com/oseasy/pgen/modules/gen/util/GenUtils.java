 ...
 *
 */
package com.oseasy.pgen.modules.gen.util;
...
import com.oseasy.pgen.modules.gen.entity.GenCategory;
...
//		}
	...
	public static Map<String, Object> getDataModel(GenScheme genScheme) {
		...
		model.put(GEN_FUNCTION_AUTHOR, StringUtil.isNotBlank(genScheme.getFunctionAuthor())?genScheme.getFunctionAuthor():CoreUtils.getUser().getName());
