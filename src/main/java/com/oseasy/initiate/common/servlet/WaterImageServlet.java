...
public class WaterImageServlet extends HttpServlet {
	public WaterImageServlet() {
		super();
	}
...
//		waterParam.setSrc(new WaterSrc());
//		waterParam.setWater(new WaterText());
//		waterParam.setBackIcon(new WaterText());
//		waterParam.setBackText(new WaterText());
//		waterParam.setParam(Lists.newArrayList());
//
//
