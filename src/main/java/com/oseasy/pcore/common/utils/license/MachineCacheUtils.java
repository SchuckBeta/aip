...
public class MachineCacheUtils {
	
	private static Logger logger = LoggerFactory.getLogger(MachineCacheUtils.class);
...
//		}
	...
	public static Cache<String, Object> getCache() {
		Cache<String, Object> cache = cacheManager.getCache(MACHINE_CACHE);
		if (cache == null) {
			throw new RuntimeException("当前系统中没有定义“"+MACHINE_CACHE+"”这个缓存。");
		}
		return cache;
	}
