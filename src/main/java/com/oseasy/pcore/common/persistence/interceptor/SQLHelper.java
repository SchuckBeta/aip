...
public class SQLHelper {
  ...
  public static int getCount(final String sql, final Connection connection,
      final MappedStatement mappedStatement, final Object parameterObject, final BoundSql boundSql,
  ...
  private static String removeOrders(String qlString) {
    Pattern p = Pattern.compile("(?<!/\\*subOrder\\*/)order\\s*by[\\w|\\W|\\s|\\S]*", Pattern.CASE_INSENSITIVE);
