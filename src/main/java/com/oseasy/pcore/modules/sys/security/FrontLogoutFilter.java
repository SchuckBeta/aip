 ...
 * @since 1.2
 */
@Service("frontLogoutFilter")
public class FrontLogoutFilter extends AdviceFilter {
    
    private static final Logger log = LoggerFactory.getLogger(FrontLogoutFilter.class);
     ...
     */
    public static final String DEFAULT_REDIRECT_URL = "/f";
