...
public class FrontShiroFilterFactoryBean implements FactoryBean, BeanPostProcessor {

    private static transient final Logger log = LoggerFactory.getLogger(FrontShiroFilterFactoryBean.class);
    ...
    public FrontShiroFilterFactoryBean() {
