...
public final class ImagePutils {
    ...
    public final static void pressImage(String targetImg, String waterImg,
                                        int x, int y, float alpha, Float roteRate) {
    ...
    public final static void pressImage(String targetImg, String waterImg,
        ...
        pressImage(targetImg, waterImg, outImg, x, y, alpha, roteRate, true);
    }
    ...
    public static void pressText(String targetImg, String outImg, String pressText, String fontName, int fontStyle, int fontSize, Color color, int x, int y, Float roteRate, float alpha) {
        pressText(targetImg, outImg, pressText, fontName, fontStyle, fontSize, color, x, y, roteRate, alpha, true);
    }
    ...
    public static void main(String[] args) throws IOException {
        //
        pressImage("C://Uwork//image//srcimg.png", "C://Uwork//image//ipree.png", "C://Uwork//image//srcimgXX1.png", 200, 250, null, 0.5f);
...
//
//        pressText("C://Uwork//image//srcimg.png", "C://Uwork//image//srcimgTT2.png", "测试水印2", "宋体", Font.BOLD|Font.ITALIC, 20, Color.WHITE, 200, 120, 30.0f, 0.8f);
//
