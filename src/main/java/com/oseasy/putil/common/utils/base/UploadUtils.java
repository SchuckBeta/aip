package com.oseasy.putil.common.utils.base;
...
public class UploadUtils {
   ...
   * 日期格式化对象.
   */
	private static final String YYYY_MM_DD_H_HMMSS = "/yyyyMM/ddHHmmss";


	public static String generateFilename(String path, String ext) {
	  SimpleDateFormat format = new SimpleDateFormat(YYYY_MM_DD_H_HMMSS);
		return path + format.format(new Date()) + RandomStringUtils.random(4, Num62.N36_CHARS) + "." + ext;
	}
