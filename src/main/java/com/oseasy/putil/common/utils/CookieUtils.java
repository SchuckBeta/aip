...
public class CookieUtils {
    public final static Logger logger = Logger.getLogger(CookieUtils.class);
	...
	public static void setCookie(HttpServletResponse response, String name, String value, String path, int maxAge) {
	    if(response == null){
	        logger.info("设置当前Cookie时,response为空！");
	        return;
	    }
//        logger.info("当前Cookie属性:[" + name + "],path=" + path+ "],maxAge=" + maxAge);
