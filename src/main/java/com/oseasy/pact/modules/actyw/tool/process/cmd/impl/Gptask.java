 ...
 *
 */
public class Gptask extends ActYwAbsEngine<ActYwEngineImpl> implements ActYwCommand<ActYwPgnode>, ActYwCommandCheck<ActYwPgnode, ActYwRgnode, ActYwGnode>{
    protected static final Logger logger = Logger.getLogger(Gptask.class);

    @Override
    public ActYwEcmd cmd() {
        return ActYwEcmd.ECMD_P_TASK;
    }
    ...
    public Gptask(ActYwEngineImpl engine) {
      super(engine);
    }
...
//        if(tpl.getCheckIgn().getIgnCheckPreId()){
//
//        }
//
...
//        }
//
//        if(!((GnodeType.GT_PROCESS_FLOW.getId()).equals(curPreGnode.getType()))){
//            tpl = new ActYwPgnode();
