 ...
 *
 */
public class Gpgate extends ActYwAbsEngine<ActYwEngineImpl> implements ActYwCommand<ActYwPgnode>, ActYwCommandCheck<ActYwPgnode, ActYwRgnode, ActYwGnode>{
    protected static final Logger logger = Logger.getLogger(Gpgate.class);

    @Override
    public ActYwEcmd cmd() {
        return ActYwEcmd.ECMD_P_GATE;
    }
    ...
    public Gpgate(ActYwEngineImpl engine) {
      super(engine);
    }
