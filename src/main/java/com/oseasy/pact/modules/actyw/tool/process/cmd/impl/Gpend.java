 ...
 *
 */
public class Gpend extends ActYwAbsEngine<ActYwEngineImpl> implements ActYwCommand<ActYwPgnode>, ActYwCommandCheck<ActYwPgnode, ActYwRgnode, ActYwGnode>{
    protected static final Logger logger = Logger.getLogger(Gpend.class);

    @Override
    public ActYwEcmd cmd() {
        return ActYwEcmd.ECMD_P_END;
    }
    ...
    public Gpend(ActYwEngineImpl engine) {
      super(engine);
    }
...
//        }
//
//        if(!((GnodeType.GT_PROCESS_GATEWAY.getId()).equals(curPreFunGnode.getType()) ||
