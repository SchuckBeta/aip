 ...
 *
 */
public class Grgate extends ActYwAbsEngine<ActYwEngineImpl> implements ActYwCommand<ActYwPgnode>, ActYwCommandCheck<ActYwPgnode, ActYwRgnode, ActYwGnode>{
    protected static final Logger logger = Logger.getLogger(Grgate.class);

    @Override
    public ActYwEcmd cmd() {
        return ActYwEcmd.ECMD_R_GATE;
    }
    ...
    public Grgate(ActYwEngineImpl engine) {
      super(engine);
    }
