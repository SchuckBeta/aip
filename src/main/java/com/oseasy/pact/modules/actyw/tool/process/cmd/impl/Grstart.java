 ...
 *
 */
public class Grstart extends ActYwAbsEngine<ActYwEngineImpl> implements ActYwCommand<ActYwPgnode>, ActYwCommandCheck<ActYwPgnode, ActYwRgnode, ActYwGnode>{
    protected static final Logger logger = Logger.getLogger(Grstart.class);

    @Override
    public ActYwEcmd cmd() {
        return ActYwEcmd.ECMD_R_START;
    }
    ...
    public Grstart(ActYwEngineImpl engine) {
      super(engine);
    }
