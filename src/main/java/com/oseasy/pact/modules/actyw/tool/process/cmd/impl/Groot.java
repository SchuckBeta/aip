 ...
 *
 */
public class Groot extends ActYwAbsEngine<ActYwEngineImpl> implements ActYwCommand<ActYwPgnode>, ActYwCommandCheck<ActYwPgnode, ActYwRgnode, ActYwGnode>{
    protected static final Logger logger = Logger.getLogger(Groot.class);

    @Override
    public ActYwEcmd cmd() {
        return ActYwEcmd.ECMD_R;
    }
    ...
    public Groot(ActYwEngineImpl engine) {
      super(engine);
    }
