 ...
 *
 */
public class Grend extends ActYwAbsEngine<ActYwEngineImpl> implements ActYwCommand<ActYwPgnode>, ActYwCommandCheck<ActYwPgnode, ActYwRgnode, ActYwGnode>{
    protected static final Logger logger = Logger.getLogger(Grend.class);

    @Override
    public ActYwEcmd cmd() {
        return ActYwEcmd.ECMD_R_END;
    }
    ...
    public Grend(ActYwEngineImpl engine) {
      super(engine);
    }
...
//        }
//
//        if(!((GnodeType.GT_ROOT_GATEWAY.getId()).equals(curPreFunGnode.getType()) ||
