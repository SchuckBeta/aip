...
import com.oseasy.pact.modules.act.utils.Variable;
import com.oseasy.pcore.common.persistence.BaseEntity;
import com.oseasy.putil.common.utils.StringUtil;
import com.oseasy.putil.common.utils.TimeUtils;
...
//	}
	...
	public String getProcDefKey() {
		if (StringUtil.isBlank(procDefKey) && StringUtil.isNotBlank(procDefId)) {
			procDefKey = StringUtil.split(procDefId, ":")[0];
		}
		return procDefKey;
	}
	...
	public boolean isFinishTask() {
		return "finish".equals(status) || StringUtil.isBlank(taskId);
	}
