            ...
            <div class="form-horizontal form-horizontal-apply mgb40">
                <div id="applicatioinDetail" class="panel-body collapse in">
                    <div class="row row-user-info">
                        ...
                        <div class="col-xs-6">
                            <label class="label-static">项目简称：</label>
                            <p class="form-control-static" style="word-break: break-all">${proModel.shortName}</p>
                        </div>
                        <div class="col-xs-6">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="form-control-static">
                                <div class="project-logo-box">
                                    <img class="img-responsive" src="${empty proModel.logo.url ? '/images/upload-default-image1.png':fns:ftpImgUrl(proModel.logo.url)}">
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12">
