...
<script>
    $(function () {
        ...
        deleteImg.click(function () {
            ...
            if (url == null || url == "" || url == '/images/upload-default-image1.png') {
                return;
            }
            ...
            <form:form id="form1" modelAttribute="proModelTlxy" action="#" method="post" class="form-horizontal"
                ...
                <div class="form-group" style="position:relative;left:45px;">
                    ...
                    <div class="col-xs-4">
                        ...
                        <input type="text" class="form-control" oldv="${proModelTlxy.proModel.shortName}"
                                                      maxlength="15" name="proModel.shortName" value="${proModelTlxy.proModel.shortName}"
                                                      placeholder="最多15个字符">
                    </div>
                </div>
                <div class="form-group" style="position:relative;left:45px;margin-top:30px;">
                    ...
                    <div class="col-xs-3">
                        <form:select path="proModel.proCategory"
                                     class="form-control required fill" oldv="${proModelTlxy.proModel.proCategory}"
                                     onchange="findTeamPerson();">
                            <form:option value="" label="--请选择--"/>
                            <form:options items="${fns:getProCategoryByActywId(proModelTlxy.proModel.actYwId)}" itemValue="value"
                                          itemLabel="label"
                ...
                <div class="form-group" style="position:relative;left:45px;margin-top:30px;">
                    ...
                    <div class="col-xs-9">
                        <textarea class="form-control required fill" oldv="${proModelTlxy.proModel.introduction }"
                                  name="proModel.introduction"
                                  rows="3"
                                  maxlength="512" placeholder="最多512个字符">${proModelTlxy.proModel.introduction }</textarea>
                    </div>
                </div>
                <div class="form-group" style="position:relative;left:45px;margin-top:30px;">
                        ...
                        <div class="col-xs-6 col-size">
                            ...
                            <div id="ground-img" style="position: relative;">
                                <div>
                                    ...
                                    <img class="backimg"
                                         src="${empty proModelTlxy.proModel.logo.url ? '/images/upload-default-image1.png':fns:ftpImgUrl(proModelTlxy.proModel.logo.url)}">
                                </div>
...
<script type="text/javascript">
    ...
    function saveStep2UnCheck(type) {
        ...
        $("#form1").attr("action", "/f/proModelTlxy/saveStep2Uncheck");
        $("#form1").ajaxSubmit(function (data) {
            if (checkIsToLogin(data)) {
                dialogCyjd.createDialog(0, "未登录或登录超时。请重新登录，谢谢！", {
                    dialogClass: 'dialog-cyjd-container none-close',
