...
<div class="container container-ct">
    ...
    <div class="row-apply">
        ...
        <form:form id="form1" modelAttribute="proModelHsxm" action="#" method="post" class="form-horizontal"
            ...
            <input type="hidden" name="proModel.id" id="proModelId" value="${proModelHsxm.proModel.id}"/>
            <input type="hidden" name="id" id="id" value="${proModelHsxm.id}"/>
            <div class="row row-user-info" style="margin-top:28px;">
                <div class="col-xs-8">
                    ...
                    <input id="declareDate" class="Wdate form-control date-input required declareDate" readonly="readonly" type="text"
                           ...
                           value='<fmt:formatDate value="${proModelHsxm.proModel.subTime}" pattern="yyyy-MM-dd"/>'
                           onfocus="WdatePicker()"/>
                </div>
            </div>
            ...
            <div class="form-group" style="position:relative;left:45px;">
                ...
                <div class="col-xs-4">
                    <input type="text" class="form-control required fill" oldv="${proModelHsxm.proModel.pName}"
                           maxlength="128" name="proModel.pName" value="${proModelHsxm.proModel.pName}"
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-6 col-size">
                        ...
                        <div id="ground-img" style="position: relative;">
                            <div>
                                <input class="hide-img" type="hidden" value="${proModelHsxm.proModel.logo.url }">
                                <img class="backimg"
                                     src="${empty proModelHsxm.proModel.logo.url ? '/images/default-pic.png':fns:ftpImgUrl(proModelHsxm.proModel.logo.url)}">
                            </div>
                            <c:if test="${empty proModelHsxm.proModel.procInsId}">
            ...
            <input id="logoSysAttId" type="hidden" value="${proModelHsxm.proModel.logo.id}">
            <div class="edit-bar edit-bar-sm clearfix">
                <div class="edit-bar-left">
                    <span>项目介绍</span>
                    <i class="line"></i>
...
2、项目的特色或创新点。(最多2000个字符)">${proModelHsxm.proModel.introduction }</textarea>
                </div>
            </div>
            <div class="form-group" style="position:relative;left:45px;margin-top:30px;">
                ...
                <div class="col-xs-9">
                    <textarea class="form-control"
                              name="innovation"
                              rows="3"
                              maxlength="2000">${proModelHsxm.innovation}</textarea>
                </div>
            </div>
            <div class="form-group" style="position:relative;left:45px;margin-top:30px;">
                ...
                <div class="input-box col-xs-9">
                    <table class="table table-bordered table-condensed table-orange table-center table-nowrap table-hover table-team yuantb">
                        ...
                        <tr>
                            <td>
                                <textarea name="planContent" class="form-control required" rows="3" maxlength="2000">${proModelHsxm.planContent}</textarea>
                            </td>
                            <td style="vertical-align: middle">
                                <div class="time-input-inline">
                                    <input id="plan-start-date" class="Wdate date-input required" type="text" readonly="readonly"
                                           ...
                                           value='<fmt:formatDate value="${proModelHsxm.planStartDate}" pattern="yyyy-MM-dd"/>'
                                           onfocus="WdatePicker()"/>
                                    <span>至</span>
                                    <input id="plan-end-date" class="Wdate date-input required" type="text" readonly="readonly"
                                           name="planEndDate" style="width: 120px;"
                                           value='<fmt:formatDate value="${proModelHsxm.planEndDate}" pattern="yyyy-MM-dd"/>'
                                           onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:true,minDate:$('#plan-start-date').val()})"/>
                                </div>
                            </td>
                            <td>
                                <textarea name="planStep" class="form-control required" rows="3" maxlength="2000">${proModelHsxm.planStep}</textarea>
                            </td>
                        </tr>
                        </tbody>
                    </table>
            ...
            <div class="form-group" style="position:relative;left:45px;margin-top:30px;">
                ...
                <div class="input-box col-xs-9">
                    <table class="table table-bordered table-condensed table-orange table-center table-nowrap table-hover table-team task">
                        ...
                        <tbody>
                        <c:if test="${proModelHsxm.planList==null||proModelHsxm.planList.size() ==0}">
                            <tr>
                                <td>
                                    1
                                </td>
                        ...
                        <c:if test="${proModelHsxm.planList!=null&&proModelHsxm.planList.size() >0}">
                            <c:forEach items="${proModelHsxm.planList}" var="item" varStatus="status">
                                <tr>
                                    <td>
                                            ${status.index+1}
                                    </td>
                                    <td>
                                        <textarea required maxlength="2000" class="form-control required" rows="3"
                                                  name="planList[${status.index}].content">${proModelHsxm.planList[status.index].content }</textarea>
                                    </td>
                                    <td>
                                        <textarea required maxlength="2000" class="form-control required" rows="3"
                                                  name="planList[${status.index}].description">${proModelHsxm.planList[status.index].description }</textarea>
                                    </td>
                                    <td style="vertical-align: middle">
                                        <div class="time-input-inline">
                                            <input required id="plan-start-date-${status.index}"
                                                   ...
                                                   style="width: 120px;"
                                                   value='<fmt:formatDate value="${proModelHsxm.planList[status.index].startDate }" pattern="yyyy-MM-dd"/>'
                                            ...
                                            <input required id="plan-end-date-${status.index}"
                                                   ...
                                                   value='<fmt:formatDate value="${proModelHsxm.planList[status.index].endDate }" pattern="yyyy-MM-dd"/>'
                                    ...
                                    <td style="vertical-align: middle">
                                        <input type="number" class="number form-control required" maxlength="20"
                                               ...
                                               value="${proModelHsxm.planList[status.index].cost }"/>
                                    </td>
                                    <td>
                                        <textarea required maxlength="2000"
                                                  name="planList[${status.index}].quality" rows="3"
                                                  class="form-control">${proModelHsxm.planList[status.index].quality }</textarea>
                                    </td>
                                    <td>
                                        <a class="minus"></a>
                                        <a class="plus"></a>
            ...
            <div class="form-group form-span-checkbox" style="position:relative;left:45px;margin-top:30px;">
                ...
                <div class="col-xs-9 input-box" style="margin-top:5px;">
                        <form:checkboxes  path="resultType" items="${fns:getDictList('project_result_type')}"
                                         ...
                                         itemLabel="label" htmlEscape="false"/>
                        <input type="hidden" id="resultTypeStr" value="${proModelHsxm.resultType}"/>
                </div>
            </div>
            <div class="form-group" style="position:relative;left:45px;margin-top:30px;">
                <label class="control-label col-xs-1" style="width: 150px;"><i>*</i>成果说明：</label>
                <div class="col-xs-9">
                    <textarea class="form-control required" rows="3" name="resultContent" maxlength="2000">${proModelHsxm.resultContent}</textarea>
                </div>
            </div>
            ...
            <div class="form-group" style="position:relative;left:45px;margin-top:30px;">
                ...
                <div class="col-xs-9">
                    <textarea class="form-control required" rows="3" placeholder="简要描述在项目各个阶段产生的费用项目及明细，如：硬件采购、耗材费、差旅费等"
                        name="budget"  maxlength="2000">${proModelHsxm.budget}</textarea>
                </div>
            </div>
        </form:form>
...
<script type="text/javascript">
    ...
    function saveStep1(obj) {
        if(tlxyValidate.form()){
            ...
            $("#form1").attr("action", "/f/proModelHsxm/ajaxSave");
            ...
            $("#form1").ajaxSubmit(function (data) {
                if (checkIsToLogin(data)) {
                    ...
                    if (data.ret == 1) {
                        top.location = "/f/proModelHsxm/applyStep2?actywId=" + $("#actYwId").val() + "&id=" +data.id;
                    } else {
