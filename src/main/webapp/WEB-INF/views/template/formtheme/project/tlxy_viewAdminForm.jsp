            ...
            <el-tab-pane label="项目信息" name="second">
                <e-panel label="项目基本信息">
                    <el-row :gutter="20" label-width="110px">
                        ...
                        <el-col :span="24">
                            <e-col-item label="项目简介：" class="white-space-pre-static word-break">
                                {{proModel.introduction}}
                            </e-col-item>
                        </el-col>
                        <el-col :span="24" v-if="proModelTlxy.innovation">
                            <e-col-item label="前期调研准备：" class="white-space-pre-static word-break">
                                {{proModelTlxy.innovation}}
                            </e-col-item>
                        </el-col>
                        <el-col :span="24">
                            <e-col-item label="项目预案：">
                                <table class="table table-bordered table-default table-hover text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{proModelTlxy.planStartDate |
                                            formatDateFilter('YYYY-MM-DD')}}至{{proModelTlxy.planEndDate |
                                            formatDateFilter('YYYY-MM-DD')}}
                                        </td>
                        ...
                        <el-col :span="24">
                            <e-col-item label="任务分工：">
                                <table class="table table-bordered table-default table-hover text-center">
                                    ...
                                    <tbody>
                                    <tr v-if="proModelTlxy.planList" v-for="(item,index) in proModelTlxy.planList"
                                        :key="item.id">
                                        <td>{{index + 1}}</td>
                ...
                <e-panel label="预期成果">
                    <el-row :gutter="20" label-width="110px">
                        <el-col :span="24">
                            <e-col-item label="成果形式：">{{proModelTlxy.resultType |
                                checkboxFilter(projectResultEntries)}}
                            </e-col-item>
                        </el-col>
                        <el-col :span="24">
                            <e-col-item label="成果说明：" class="white-space-pre-static word-break">
                                {{proModelTlxy.resultContent}}
                            </e-col-item>
                        </el-col>
                    </el-row>
                </e-panel>
                ...
                <e-panel label="经费预算">
                    <el-row :gutter="20" label-width="110px">
                        ...
                        <el-col :span="24">
                            <e-col-item label="经费预算明细：" class="white-space-pre-static word-break">
                                {{proModelTlxy.budget}}
                            </e-col-item>
                        </el-col>
                    </el-row>
                ...
                <e-panel :label="item.gnodeName" v-if="projectTlxyReports.length > 0" v-for="item in projectTlxyReports"
                         :key="item.id">
                    <ul class="timeline">
                    ...
                    <el-row :gutter="20" label-width="150px" style="margin-left:53px;">
                        <el-col :span="20">
                            <e-col-item label="已取得阶段性成果：" class="white-space-pre-static word-break">{{item.stageResult
                                || ''}}
                            </e-col-item>
                        </el-col>
                    </el-row>
...
<script>
    ...
    new Vue({
        ...
        data: function () {
            ...
            var actYwStatusList =
            ${fns: toJson(actYwStatusList)} ||
            [];
            var auditRecordList =
            ${fns: toJson(actYwAuditInfos)} ||
            [];
            var leader;
            var proModelTlxy =
            ${fns: toJson(proModelTlxy)} ||
            {
            }
            ;
