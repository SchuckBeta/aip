            ...
            <div class="form-horizontal form-horizontal-apply mgb40">
                <div id="applicatioinDetail" class="panel-body collapse in">
                    <div class="row row-user-info">
                        ...
                        <div class="col-xs-12">
                            <label class="label-static">所属领域：</label>
                            <p class="form-control-static">${proModelGzsmxx.regionName}</p>
                        </div>
                        <div class="col-xs-12">
                            <label class="label-static">领域分组：</label>
                            <p class="form-control-static">${proModelGzsmxx.regionGroupName}</p>
                        </div>
                        <div class="col-xs-12">
                            <label class="label-static">作品简介：</label>
