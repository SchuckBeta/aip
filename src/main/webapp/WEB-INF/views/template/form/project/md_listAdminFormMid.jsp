...
<head>
    ...
    <script type="text/javascript">
        ...
        function expData() {
	        ...
	        //$.get('/a/proprojectmd/expMidPlus?gnodeId=${gnodeId}' + "&actywId=" + $("#actywId").val(), {}, function (data) {
            //$.get('/a/proprojectmd/expMidPlus?type=${type}&actywId=${actywId}&gnodeId=${gnodeId}', {}, function (data) {
            //$.get('/a/proprojectmd/expMidPlus?actywId=${actywId}&gnodeId=${gnodeId}', {}, function (data) {
