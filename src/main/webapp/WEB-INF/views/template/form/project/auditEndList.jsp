...
<body>
		...
		<ul class="nav nav-tabs"  style="margin-top: 10px;">
			<li class="active"><a href="${ctx}/gcontest/gContest/schoolEndAuditList/">待审核</a></li>
			<li><a href="${ctx}/gcontest/gContest/schoolEndAuditedList/">已审核</a></li>
		</ul>

	<form:form id="searchForm" modelAttribute="gContest" action="${ctx}/gcontest/gContest/schoolEndAuditList" method="post" class="breadcrumb form-search clearfix">
