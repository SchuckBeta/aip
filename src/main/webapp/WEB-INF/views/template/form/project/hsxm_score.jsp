...
<div id="app" v-show="pageLoad" style="display: none" class="container-fluid mgb-60">
    ...
    <div class="panel panel-project mgb-20">
        ...
        <div class="panel-body">
            ...
            <div class="project-info_list">
                ...
                <e-col-item label="项目类别：" align="right" style="margin-bottom: 10px;">{{proModel.proCategory | selectedFilter(proCategoryEntries)}}
                </e-col-item>
    ...
    <div class="pro-contest-content panel-padding-space">
        <el-tabs class="pro-contest-tabs" v-model="tabActiveName">
            ...
            <el-tab-pane label="评分" name="four">
                <e-panel label="评分">
                    <score-form label="评分" :action="frontOrAdmin + '/promodel/proModel/promodelGateAudit'" @submit-complete="submitComplete">
