...
<%--<head>--%>
    ...
    <%--<script type="text/javascript">--%>
        ...
        <%--}--%>
       	<%--function expData(){--%>
       		<%--location.href="/a/proprojectmd/expApproval";--%>
       	<%--}--%>
       	<%--function impData(){--%>
       		<%--location.href="/a/proprojectmd/impApprovalPage";--%>
       	<%--}--%>
    <%--</script>--%>
<%--</head>--%>
<%--<body>--%>
            ...
            <%--<tr>--%>
                ...
                <%--<td>--%>
                    ...
                    <%--<c:if test="${act.status=='finish'}">--%>
                        <%--<a href="${ctx}/actyw/actYwGnode/designView?groupId=${auditGonde.group.id}&proInsId=${act.task.processInstanceId}" class="check_btn btn-pray btn-lx-primary" target="_blank">查看</a>--%>
                        <%--&lt;%&ndash; ${ctx}/promodel/proModel/view?id=${act.vars.map.id}&taskDefinitionKey=${act.task.taskDefinitionKey}">查看</a>&ndash;%&gt;--%>
                    <%--</c:if>--%>
                <%--</td>--%>
            <%--</tr>--%>
        <%--</c:forEach>--%>
