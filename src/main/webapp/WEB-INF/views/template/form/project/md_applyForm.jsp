...
<div class="container container-ct">
    ...
    <form:form id="competitionfm" modelAttribute="proModelMd" action="/f/proprojectmd/proModelMd/ajaxSave" method="post" class="form-horizontal"
...
<script src="/js/md/mdApplyBak.js?v=11" type="text/javascript" charset="utf-8"></script>
