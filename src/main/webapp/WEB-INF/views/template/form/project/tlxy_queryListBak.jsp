    ...
    <form:form id="searchForm" modelAttribute="proModelTlxy" action="${actionUrl}" method="post"
        ...
        <div class="text-right mgb-20">
            <shiro:hasPermission name="sys:user:import">
               	<button id="impBtn" type="button" class="btn btn-primary" onclick="toImpPage(true, '${actywId}', '', true);">导入</button>
            </shiro:hasPermission>
        ...
        <table id="contentTable"
            ...
            <c:forEach items="${page.list}" var="item">
                ...
                <tr>
                    ...
                    <td><a href="${ctx}/promodel/proModel/viewForm?id=${item.proModel.id}">${item.proModel.pName}</a></td>
                    ...
                    <td>
                        <div class="actions">
                            <shiro:hasPermission name="promodel:promodel:modify">
                                <a class="btn btn-primary btn-small" href="${ctx}/promodel/proModel/projectEdit?id=${item.proModel.id}&secondName=变更">
                                    变更
                                </a>
                            ...
                            <button class="btn btn-small btn-primary" onclick="getAuditInfo('${item.proModel.id}')">审核记录</button>
...
<script>
    ...
    function toImpPage(isQuery, actywId, gnodeId, isTrue) {
