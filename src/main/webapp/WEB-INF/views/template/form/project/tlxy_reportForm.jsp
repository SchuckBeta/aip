            ...
            <el-tab-pane :label="gnodeName" name="four">
                <e-panel :label="gnodeName">
                    <el-form :model="reportForm" :rules="reportFormRules" ref="reportForm" size="mini" :disabled="reportFormDisabled"
                        ...
                        <el-form-item>
                            <el-button type="primary" @click.stop.prevent="submitTask">{{gnodeName}}</el-button>
                            <el-button type="default" @click.stop.prevent="goToBack">返回</el-button>
                        </el-form-item>
                    </el-form>
                </e-panel>
            </el-tab-pane>
...
<script type="text/javascript">
    ...
    new Vue({
        ...
        data: function () {
            ...
            var leader;
            var proReport = ${fns: toJson(proReport)} || {};
//
