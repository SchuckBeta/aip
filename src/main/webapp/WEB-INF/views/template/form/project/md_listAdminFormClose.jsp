    ...
    <script type="text/javascript">
        ...
        function expData() {
            ...
            $(".expbtn").attr("disabled", true);
          	//$.get('/a/proprojectmd/expClosePlus?gnodeId=${gnodeId}' + "&actywId=" + $("#actywId").val(), {}, function (data) {
            //$.get('/a/proprojectmd/expClosePlus?type=${type}&actywId=${actywId}&gnodeId=${gnodeId}', {}, function (data) {
        ...
        function getExpInfo() {
            $.ajax({
                type: "GET",
                url: "/a/proprojectmd/getExpCloseInfo",
                dataType: "json",
        ...
        <c:forEach items="${page.list}" var="proModelMd">
            ...
            <tr>
                ...
                <td>
                    ...
                    <%--<td>--%>
                    <%--<a class="btn btn-back-oe btn-primaryBack-oe btn-small" >查看</a>--%>
                    <%--</td>--%>
            </tr>
        </c:forEach>
        </tbody>
