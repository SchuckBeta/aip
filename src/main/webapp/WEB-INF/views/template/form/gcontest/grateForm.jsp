        ...
        <form:form id="inputForm" modelAttribute="proModel" action="${ctx}/promodel/proModel/promodelAudit"
            ...
            <div id="proPF" class="panel-body collapse in">
                          <div class="row-fluid">
                              ...
                              <div class="span6">
                                  <p class="pf-item"><strong>填表日期：</strong>
                                      <c:if test="${proModel.subTime!=null && proModel.subTime!=''}">
                                      <fmt:formatDate value="${proModel.subTime}" pattern="yyyy-MM-dd"/>
                                      </c:if>
                                  </p>
            ...
            <div id="panelBaseInfo" class="panel-body collapse in">
                <div class="row-fluid">
                    <div class="span6">
                        ...
                        <p class="pf-item">
                            <strong>参赛组别：</strong> ${fns:getDictLabel(proModel.level, "gcontest_level", "")}</p>
                    </div>
                    <div class="span6">
                        <p class="pf-item">
                            <strong>大赛类型：</strong> ${fns:getDictLabel(proModel.proCategory, "competition_net_type", "")}</p>
                        <p class="pf-item">
