    ...
    <form:form id="searchForm" modelAttribute="proModelGzsmxx" action="${actionUrl}" method="post"
        ...
        <div class="col-control-group">
            <div class="control-group">
                ...
                <div class="controls">
                    <form:select id="gnodeId" path="proModel.gnodeId" class="input-medium">
            ...
            <div class="control-group" style="margin-right: 400px;">
                ...
                <div class="controls">
                    <select class="input-medium form-control" name="proModel.hasAssigns">
                        <option value="">--全部--</option>
                        <option value="0"
                                <c:if test="${proModelGzsmxx.proModel.hasAssigns eq '0'}">selected</c:if> >未指派
                        </option>
                        <option value="1"
                                <c:if test="${proModelGzsmxx.proModel.hasAssigns eq'1'}">selected</c:if> >已指派
                        </option>
                    </select>
                </div>
            </div>
        ...
        <div class="search-btn-box">
            <form:input class="input-xlarge" path="proModel.queryStr" htmlEscape="false" maxlength="100"
                        autocomplete="off"
    ...
    <div id="auditInfo">
        <table id="contentTable"
            ...
            <tr>
                ...
                <th width="140" data-name="pm.competition_number">
                    <a class="btn-sort" href="javascript:void(0);">编号<i class="icon-sort"></i></a>
                </th>
                <th width="25%" data-name="pm.p_name">
                    <a class="btn-sort" href="javascript:void(0);">作品名称<i class="icon-sort"></i></a>
                </th>
                <th>领域分组</th>
                <th data-name="u.name">
                    <a class="btn-sort" href="javascript:void(0);">负责人<i class="icon-sort"></i></a>
                </th>
                <th data-name="o6.name">
                    <a class="btn-sort" href="javascript:void(0);">学院<i class="icon-sort"></i></a>
                </th>
                <th>组人数</th>
                <th>指导老师</th>
                <th>报名日期</th>
            ...
            <c:forEach items="${page.list}" var="item">
                ...
                <tr>
                    <td><input type="checkbox" name="subck" onclick="subckchange(this)" value="${item.proModel.id}">
                    </td>
                    ...
                    <td>
                        <c:choose>
                            <c:when test="${empty item.proModel.taskAssigns}">
                                未指派
                            </c:when>
                            <c:otherwise>
                                已指派
                    ...
                    <td>
                        <c:choose>
                            <c:when test="${item.proModel.state == '1' and empty item.proModel.procInsId}">
                                项目已结项
                            </c:when>
                            <c:otherwise>
