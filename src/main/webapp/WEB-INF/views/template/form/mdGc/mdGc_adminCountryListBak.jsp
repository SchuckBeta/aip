...
<div class="container-fluid">
    ...
    <form:form id="searchForm" modelAttribute="proModelMdGc" action="${actionUrl}" method="post"
        ...
        <div class="search-btn-box">
            ...
            <%--<button type="button" class="btn btn-primary" onclick="toimppage()">导入</button>--%>
    ...
    <table id="contentTable"
        ...
        <tr>
            ...
            <th width="140" data-name="a.competition_number"><a class="btn-sort" href="javascript:void(0);">编号<i class="icon-sort"></i></a></th>
            <th width="25%" data-name="a.p_name"><a class="btn-sort" href="javascript:void(0);">作品名称<i class="icon-sort"></i></a></th>
...
<script>
    ...
    function toimppage() {
        location.href = "/a/impdata/promodelgcontestlist?actywId=${actywId}" + "&gnodeId=" + '${gnodeId}';
    }
