    ...
    <div>
        <form:form modelAttribute="pwAppointmentVo" class="form-inline form-appointment"
            ...
            <div class="cate-check-bar" style="margin-left: -10px;">
                <div class="ch-wrap">
                    <div class="ch-block controls-checkbox" style="padding:0 10px;" >
...
<script>
    ...
    +(function ($) {
        ...
        <%--console.log(JSON.parse('${fns:toJson(fns:getDictList('pw_room_type'))}'))--%>
        var viewWeek = new Vue({
            ...
            methods: {
                ...
                search: function () {
                    var self = this;
                    var xhr = $.get('${ctx}/pw/pwAppointment/mouthSearch', this.form);
...
//                        this.roomIndex = 'all';
                        ...
                        this.form.roomId = this.appointmentForm.roomId;
                    }
                    ...
                    xhr = $.get('${ctx}/pw/pwAppointment/mouthSearch', this.roomForm);
                    xhr.success(function (data) {
                        self.changeCalendarData(data)
                    });
...
//                        var view = self.calendar.fullCalendar('getView');
                        ...
                        if(calEvent.state == 0){
                            location.href = '${ctx}/pw/pwAppointment/review';
                            return false;
                        }

                        if(calEvent.state == 1 || calEvent.state == 3){
                            location.href = '${ctx}/pw/pwAppointment/list';
                            return false;
                        }
                        if(calEvent.state == 4 || calEvent.state == 2){
                            return false;
                        }

                        var link = calEvent.link;
                        var xhr = $.get('${ctx}' + link);
                        xhr.success(function (data) {
                            if (data) {
                    ...
                    dayClick: function (calEvent) {
                        ...
                        location.href = '${ctx}/pw/pwAppointment/viewDay?searchDay=' + moment(date).format('YYYY-MM-DD');
                    }
                });
        ...
        $(document).on('click', 'a.fc-day-number', function () {
            ...
            location.href = '${ctx}/pw/pwAppointment/viewDay?searchDay='+ goto.date;
        })
    })(jQuery);
