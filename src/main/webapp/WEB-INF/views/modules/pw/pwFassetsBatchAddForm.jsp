...
<div id="app" v-show="pageLoad" style="display: none" class="container-fluid mgb-60">
    <div class="mgb-20">
        <shiro:hasPermission name="pw:pwFassets:edit">
            <edit-bar :second-name="saveForm.id ? '修改': '批量添加'" href="/pw/pwFassets/list"></edit-bar>
        </shiro:hasPermission>
    ...
    <el-form size="mini" :model="saveForm" :rules="saveFormRules" ref="saveForm" :disabled="formDisabled"
        ...
        <el-form-item prop="pwFassets.pwCategory.parent.id" label="资产类别：">
            <el-select name="parentId" size="mini" v-model="saveForm.pwFassets.pwCategory.parent.id" @change="handleChangeAssetsTypes"
        ...
        <el-form-item prop="pwFassets.pwCategory.id" label="资产名称：">
            <el-select name="pwCategoryId" size="mini" v-model="saveForm.pwFassets.pwCategory.id" clearable placeholder="请选择资产名称" class="w300">
                <el-option
        ...
        <el-form-item prop="pwFassets.brand" label="品牌：">
            <el-input name="brand" v-model="saveForm.pwFassets.brand" class="w300"></el-input>
        </el-form-item>

        <el-form-item prop="pwFassets.specification" label="规格：">
            <el-input name="specification" v-model="saveForm.pwFassets.specification" class="w300"></el-input>
        </el-form-item>

        <el-form-item prop="pwFassets.prname" label="购买人：">
            <el-input name="prname" v-model="saveForm.pwFassets.prname" class="w300" maxlength="20"></el-input>
        </el-form-item>

        <el-form-item prop="pwFassets.phone" label="手机号码：">
            <el-input name="phone" v-model="saveForm.pwFassets.phone" class="w300"></el-input>
        </el-form-item>

        <el-form-item prop="pwFassets.time" label="购买时间：">
            <el-date-picker
                    v-model="saveForm.pwFassets.time"
                    type="date"
        ...
        <el-form-item prop="pwFassets.price" label="单价：">
            <el-input name="price" v-model="saveForm.pwFassets.price" class="w300">
                <template slot="append">元（人民币）</template>
            </el-input>
        </el-form-item>

        <el-form-item prop="amount" label="购买数量：">
            <el-input name="amount" v-model="saveForm.amount" class="w300" maxlength="3"></el-input>
        </el-form-item>

        <el-form-item prop="pwFassets.remarks" label="备注：">
            <el-input type="textarea" name="remarks" :rows="5" v-model="saveForm.pwFassets.remarks" maxlength="200" style="width:500px;"></el-input>
        </el-form-item>
    ...
    new Vue({
        ...
        data: function () {
            ...
            var validateAmount = function (rule, value, callback) {
                if (value && !positiveReg.test(value)) {
                    callback(new Error('请输入正整数'));
                }else{
                    callback();
                }
        ...
        methods: {
            ...
            handleChangeAssetsTypes:function (value) {
                if(!value){
                    this.saveForm.pwFassets.pwCategory.id = '';
                    this.assetsNames = [];
                    return false;
                }
            ...
            saveAssetAjax:function () {
                ...
                this.$axios({
                    ...
                    if(data.success){
                        ...
                        self.assetsNames = [];
                        self.saveForm.pwFassets.pwCategory.parent.id = data.id;
                    }
            ...
            addAssetsNames:function () {
                this.assetNameForm.parent.id = this.saveForm.pwFassets.pwCategory.parent.id;
            ...
            saveAssetNameAjax:function () {
                ...
                this.$axios({
                    ...
                    var data = response.data;
                    if(data.success){
                        self.saveForm.pwFassets.pwCategory.parent.id = self.assetNameForm.parent.id;
                        self.getChildrenCategory(self.assetNameForm.parent.id);
                        self.saveForm.pwFassets.pwCategory.id = data.id;
