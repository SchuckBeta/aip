    ...
    new Vue({
        ...
        methods: {
            getDataList: function () {
                ...
                this.$axios({
                    method: 'GET',
                    url: '/pw/pwEnter/ajaxListQXRZ?type=0&' + Object.toURLSearchParams(this.searchListForm)
            ...
            batchBack: function (arr) {
                ...
                arr.forEach(function (item) {
                    if(item.status == '60'){
                        backAlreadyName.push(item.eteam.team.name);
                        flag = false;
                    }else{
                        canBackNames.push(item.eteam.team.name);
                        canBackIds.push(item.id);
                    }
                });
                tip = '退孵后的团队将退出基地，是否继续？';
                if(!flag){
