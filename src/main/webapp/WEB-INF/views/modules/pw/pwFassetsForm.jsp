    ...
    <div class="content_panel">
        <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="${ctx}/pw/pwFassets/form?id=${pwFassets.id}">固定资产<shiro:hasPermission
                    name="pw:pwFassets:edit">${not empty pwFassets.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission
        ...
        <form:form id="inputForm" modelAttribute="pwFassets" action="${ctx}/pw/pwFassets/save" method="post"
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <form:select path="pwCategory.parent.id" class="form-control required" id="category1">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <form:select path="pwCategory.id" class="form-control required" id="category2">
                        <form:option value="" label="---请选择---"/>
                    </form:select>
                        <%--<a href="${ctx}/pw/pwCategory/form">找不到？添加</a>--%>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <form:input path="specification" type="text" class=""/>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label">购买人：</label>
                <div class="controls">
                    <form:input path="prname" maxlength="20" type="text" class=""/>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label">手机号码：</label>
                <div class="controls">
                    <form:input path="phone" type="text" class="phone_number"/>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label">购买时间：</label>
                <div class="controls">
                    <input name="time" type="text" maxlength="20"
                           class="Wdate"
                           readonly="true"
                           value="<fmt:formatDate value="${pwFassets.time}" pattern="yyyy-MM-dd"/>"
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <form:input path="price" type="text" class="number input-mini" maxlength="10"/>
