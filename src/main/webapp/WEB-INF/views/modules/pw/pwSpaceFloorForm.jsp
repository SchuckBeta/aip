...
<div id="app" v-show="pageLoad" style="display: none" class="container-fluid mgb-60">
    ...
    <el-form size="mini" :model="floorForm" :rules="floorFormRules" ref="floorForm" :disabled="formDisabled"
             label-width="120px" action="${ctx}/pw/pwSpace/save" method="POST">

        <input type="hidden" id="id" name="id" :value="floorForm.id">
        <input type="hidden" id="parent.id" name="parent.id" :value="floorForm.parentId">
        ...
        <el-form-item label="所属楼栋：" v-if="building">
            {{building}}
        </el-form-item>

        <el-form-item prop="name" label="楼层名称：">
            <el-input name="name" v-model="floorForm.name" class="w300"></el-input>
        </el-form-item>

        <el-form-item prop="remarks" label="备注：">
            <el-input name="remarks" type="textarea" :rows="5" v-model="floorForm.remarks" maxlength="200" style="width:500px;"></el-input>
        </el-form-item>
