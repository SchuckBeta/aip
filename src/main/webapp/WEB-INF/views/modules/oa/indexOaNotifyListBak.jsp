...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            var message = "${message}";
            message && dialogCyjd.createDialog("1", message, {
...
<div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-batch btn-primary-oe" aria-hidden="true" id="confirmBtn" onclick="doBatch('/f/oa/oaNotify/deleteSendBatch');" style="width: auto; height: auto;color: #fff">确定</button>
