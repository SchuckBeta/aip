...
<div class="container-fluid">
    ...
    <ul class="nav nav-tabs nav-tabs-default">
        <li><a href="/a/oa/oaNotify/msgRecList">接收消息</a></li>
        <li class="active"><a href="javascript:void(0)">发送消息</a></li>
    </ul>
    <div class="tab-content-default">
        <form:form id="searchForm" modelAttribute="oaNotify" class="form-inline" action="/a/oa/oaNotify/msgSendList"
                   method="post">
            ...
            <c:forEach items="${page.list}" var="oaNotify" varStatus="status">
                <tr key_5f820f675bfe4ffbb2b18f49ae12cbfe="${oaNotify.id}">
                    ...
                    <td data-notify-id="${oaNotify.id }" data-notify-type="${oaNotify.type}">
                        ...
                        <a href="/a/oa/oaNotify/deleteSend?id=${oaNotify.id}" class="btn btn-default btn-small">删除</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
...
<div id="notifyModal" class="modal notify-modal hide" tabindex="-1" role="dialog">
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal" style="width: auto; height: auto">关闭
        </button>
    </div>
</div>
<script>
    ...
    function resall() {
        ...
        confirmx("确定删除？", function () {
            $.ajax({
                type: 'post',
                url: '/a/oa/oaNotify/deleteSendBatch',
                dataType: "json",
                data: {
                    ids: temarr.join(",")
                },
