                                        ...
                                        <tr>
                                            <td>
                                                <div class="pro-info">
                                                    ...
                                                    <p>项目周期：<fmt:formatDate value="${projectExp.startDate }"
                                                                            pattern="yyyy-MM-dd"/>
                                                        -
                                            ...
                                            <td>
                                                <div class="teacher-leaders">
                                                    <c:forEach items="${projectExp.userList}" var="user"
                                                               varStatus="sta">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="ic-box">
                                                    ...
                                                    <div class="user-val">
                                                        <fmt:formatDate value="${projectExp.startDate }"
                                                                        pattern="yyyy-MM-dd"/>
                                                        -
                                                        <fmt:formatDate value="${projectExp.endDate }"
                                                                        pattern="yyyy-MM-dd"/>
                                    ...
                                    <c:forEach items="${gContestExpVo}" var="gContest">
                                        <tr>
                                            <td>
                                                <div class="pro-info">
                                                    <h5>
                                                        <a href="#">${fns:getDictLabel(gContest.type, 'competition_type', '')}</a>
                                                        <c:choose>
                                                    ...
                                                    <p>大赛参赛时间：<fmt:formatDate value="${gContest.createDate }"
                                                                              pattern="yyyy-MM-dd"/></p>
                                                </div>
                                            </td>
                                            <td>
