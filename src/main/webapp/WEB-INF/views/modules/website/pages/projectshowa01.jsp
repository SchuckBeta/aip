...
<div class="container" style="margin-top: 40px;">
	...
	<div class="system_info">
		...
		<div class="systemright">
			...
			<button type="button">工程测量</button>
			<button type="button">航空摄影测量</button>
		</div>
	</div>
	<div style="clear: both;"></div>
...
<div class="introduction">
	<div class="introduction_info container">
		...
		<div class="xmone" style="width: 100%">
			<ul>
				<li>项目简介</li>
				<li><img src="/img/pro-detail01.jpg"></li>
				<li style="width: auto;height: auto">本项目使用了载波相位法，通过GNSS接收机同时跟踪了22颗GPS卫星、北斗、Glonass、Galileo等卫星，通过RTK技术，以基准站对流动站进行误差改正，实现了动态实时精准定位。</li>
			</ul>
		</div>
...
<div class="product container">
	...
	<div class="productdisplay" style="text-align: center">
		<img src="/img/pro-detail-big0101.jpg" style="width: 75%;height: auto;margin: 15px auto">
		<img src="/img/pro-detail-big0102.jpg" style="width: 75%;height: auto;margin: 15px auto">
		<img src="/img/pro-detail-big0103.jpg" style="width: 75%;height: auto;margin: 15px auto">
	</div>
	<div style="clear: both;"></div>
