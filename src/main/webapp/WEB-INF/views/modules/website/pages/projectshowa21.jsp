...
<div class="introduction">
	<div class="introduction_info container">
		...
		<div class="xmone" style="width: 100%">
			<ul>
				<li>项目简介</li>
				<li><img src="/img/pro-detail21.jpg"></li>
...
<div class="product container">
	...
	<div class="productdisplay" style="text-align: center">
		<img src="/img/pro-detail-big2101.jpg" style="width: auto;max-width: 75%;height: auto;margin: 15px auto">
		<img src="/img/pro-detail-big2102.jpg" style="width: auto;max-width: 75%;height: auto;margin: 15px auto">
	</div>
	<div style="clear: both;"></div>
