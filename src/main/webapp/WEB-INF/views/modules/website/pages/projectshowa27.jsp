...
<div class="container" style="margin-top: 40px;">
	...
	<div class="system_info">
		<h3>支持隐私保护的安全数据库设计与实现</h3>
		<p>项目来源:创新创业项目 &nbsp;&nbsp;发布时间:2016-12-10</p>
		<div class="system">
			<img src="/img/pro-detail27.jpg" />
		</div>
		<div class="systemright">
			...
			<button type="button">数据安全</button>
		</div>
	</div>
	<div style="clear: both;"></div>
...
<div class="introduction">
	<div class="introduction_info container">
		...
		<div class="xmone" style="width: 100%">
			<ul>
				<li>项目简介</li>
				<li><img src="/img/pro-detail27.jpg"></li>
				<li style="width: auto;height: auto">在已有的Mini数据库系统的基础上，结合最新的数据库安全领域的已有研究成果，运用最前沿的安全技术，设计并实现一个支持隐私保护的安全数据库系统Crypt DB，可支持密文状态下数据库中存储和检索等各项操作，保护了数据的隐私和安全。同时本数据库中的技术方案还可支持用户的访问权限控制和查询结果的完整性认证，可以防止其他用户对数据的非法访问，并且保证了查询结果的完整性。</li>
			</ul>
		</div>
...
<div class="product container">
	...
	<div class="productdisplay" style="text-align: center">
		<img src="/img/pro-detail-big2701.jpg" style="width: 75%;height: auto;margin: 15px auto">
		<img src="/img/pro-detail-big2702.jpg" style="width: 75%;height: auto;margin: 15px auto">
		<img src="/img/pro-detail-big2703.jpg" style="width: 75%;height: auto;margin: 15px auto">
	</div>
	<div style="clear: both;"></div>
...
<div class="team container">
	...
	<div class="classBox" style="text-align: center">
		<img style="width: 75%;height: auto" src="/img/teampic1.jpg">
