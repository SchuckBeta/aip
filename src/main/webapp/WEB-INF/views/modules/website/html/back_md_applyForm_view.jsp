...
<div class="container-fluid">
    <div class="form-horizontal form-horizontal-apply">
        <div class="apply-form-container">
            <div class="tool-bar">
                <span>项目编号：123213123123123123</span>
                <span>填表日期：2017/07/19</span>
                <span>申请人：王清腾</span>
            </div>
            ...
            <div class="row-fluid">
                <div class="span3">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <p class="controls-static">123123123123</p>
                        </div>
                    </div>
                </div>
                <div class="span3">
            ...
            <div class="row-fluid">
                <div class="span4">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <p class="controls-static">我的团队</p>
                        </div>
                    </div>
                </div>
                <div class="span4">
                    ...
                    <li class="file-item">
                        <div class="file-info">
                            ...
                            <a href="javascript:void(0);" data-url="${attachment.ftpUrl}"
                               ...
                               data-ftp-url="${attachment.url}">压缩文件</a>
                        </div>
                    </li>
                    <li class="file-item">
                        <div class="file-info">
