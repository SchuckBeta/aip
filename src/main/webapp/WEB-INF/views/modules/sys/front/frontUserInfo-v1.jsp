...
<head>
    ...
    <style>
        ...
        .has-form-control-show .w317:last-child {
            margin-right: 0;
        }
        ...
        $(function () {
            ...
            phoneNumberValidate = $phoneNumberForm.validate({
                rules: {
                    mobile: {
                        isMobileNumber: true,
                        remote: '${ctxFront}/sys/user/checkMobileExist'
                    },
                    yzm: {
                        remote: '${ctxFront}/mobile/checkMobileValidateCode'
                    }
                },
                messages: {
                    mobile: {
                    ...
                    buttons: [{
                        ...
                        click: function (e) {
                            ...
                            if (phoneNumberValidate.form()) {
                                ...
                                var xhr = $.post('${ctxFront}/sys/frontStudentExpansion/updateMobile', {
                                    mobile: mobile,
...
<div class="container" style="padding-top: 50px;padding-bottom: 30px;width: 1270px;">
    <ol class="breadcrumb" style="background: none">
        ...
        <li><a href="/f/sys/frontStudentExpansion/findUserInfoById">学生信息查看</a></li>
    ...
    <form:form id="inputForm" modelAttribute="studentExpansion"
               action="${ctxFront}/sys/frontStudentExpansion/updateUserInfo" method="post"
               autocomplete="off"
                    ...
                    <div class="lm-inner">
                        ...
                        <div id="nav-list" class="nav-list">
                            <ul class="nav">
                                ...
                                <li><a href="#jsProjectExp"><i class="iconx-info-exp"></i>项目经历</a></li>
                                <li><a href="#jsBigExp"><i class="iconx-info-bigExp"></i>大赛经历</a></li>
                                ...
                                <li><a href="/f/sys/frontStudentExpansion/frontUserMobile"><i
                                        class="iconx-info-mobile"></i>修改手机信息</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            if(!first){
	    		...
	    		if(enterDateStr!=""&&cyclev!=""){
	    			...
	    			if(isGraduate(enterDateStr,cycle)){//毕业
	    				if(value=="1"||value=="3"){
	   						showModalMessage(0, '选择错误，你已经毕业');
	   						$("#currState").val($(this).attr("oldv"));
	    					return;
	    				}
	    			}else{
	    				if(value=="2"){
		   					showModalMessage(0, '选择错误，你还未毕业');
	    					$("#currState").val($(this).attr("oldv"));
		   					return;
	   					}
	    			}
