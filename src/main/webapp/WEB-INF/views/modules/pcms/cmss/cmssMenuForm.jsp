...
<script type="text/javascript">
    ...
    new Vue({
        ...
        methods: {
            ...
            goToBack: function () {
                location.href = this.frontOrAdmin + '/cmss/cmssMenu/'
            },
            ...
            postMenu: function () {
                ...
                this.$axios.post('/cmss/cmssMenu/saveMenu', menuForm).then(function (response) {
            ...
            getMenuList: function () {
                var self = this;
                this.$axios.get('/cmss/cmssMenu/treeData').then(function (response) {
