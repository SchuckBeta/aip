...
<script type="text/javascript">
    ...
    new Vue({
        ...
        methods: {
            ...
            goToBack: function () {
                location.href = this.frontOrAdmin + '/cms/cmsMenu/'
            },
            ...
            postMenu: function () {
                ...
                this.$axios.post('/cms/cmsMenu/saveMenu', menuForm).then(function (response) {
            ...
            getMenuList: function () {
                var self = this;
                this.$axios.get('/cms/cmsMenu/treeData').then(function (response) {
