...
<script type="text/javascript">
    ...
    new Vue({
        ...
        methods: {
            ...
            goAddMenu:function () {
                window.location.href = this.frontOrAdmin + '/cms/cmsMenu/form';
            },

            goChangeData:function (id) {
                window.location.href = this.frontOrAdmin + '/cms/cmsMenu/form?id=' + id;
            },

            goAddChild:function (id) {
                window.location.href = this.frontOrAdmin + '/cms/cmsMenu/form?parent.id=' + id;
            },
            ...
            singleDeleteRequest:function (id) {
                ...
                this.$axios({
                    method: 'POST',
                    url: '/cms/cmsMenu/ajaxDeleteMenu',
                    data: {id: id}
                }).then(function (response) {
                    var data = response.data;
                    if (data.status == '1') {
            ...
            saveSorts:function () {
                ...
                this.$axios({
                    method: 'POST',
                    url: '/cms/cmsMenu/ajaxUpdateSort',
                    data:{
                        menuList:obj
                    }
                }).then(function (response) {
            ...
            handleChangeIsShow:function (row) {
                ...
                this.$axios({
                    method: 'POST',
                    url: '/cms/cmsMenu/ajaxChangeMenuIsShow',
                    data: {
                        id: row.id,
                        isShow: row.isShow
                    }
            ...
            getMenuTree: function () {
                var self = this;
                this.loading = true;
                this.$axios.get('/cms/cmsMenu/getMenuTree').then(function (response) {
                    var data = response.data;
                    if(data.status === 1){
