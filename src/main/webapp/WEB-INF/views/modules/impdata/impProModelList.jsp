    ...
    new Vue({
        ...
        methods: {
            ...
            deleteProCt: function (row) {
                var self = this;
                this.$axios.delete('/impdata/deleteProCt?id=' + row.id).then(function (response) {
            ...
            downloadErrorData: function (scope) {
                location.href = this.frontOrAdmin + '/impdata/expProModelData?id=' + scope.row.id+'&actywId=${actywId}';
            },

            downTemplate: function () {
                location.href = this.frontOrAdmin + '/impdata/downProModelTemplate?1=1&' + Object.toURLSearchParams({
            ...
            uploadFile: function () {
                ...
                this.$axios({
                    method: 'POST',
                    url: '/impdata/importProModelData',
                    params: {
                        actywId: this.searchListForm.actywId,
            ...
            getImpProModelList: function () {
                ...
                this.$axios({
                    method: 'GET',
                    url: '/impdata/getImpProModelList',
...
//                this.$axios.get('/impdata/getImpInfo?id='+ scope.)
            ...
            setSearchListForm: function (data) {
              ...
              //  this.searchListForm.actywId = data.actywId;
               // this.searchListForm.gnodeId = data.gnodeId;
                this.searchListForm.isTrue = data.isTrue;
