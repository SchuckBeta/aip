...
<div class="container-fluid">
    ...
    <form:form id="searchForm" modelAttribute="gContest" action="${ctx}/gcontest/gContest/collegeExportScore"
               method="post" class="form-horizontal clearfix form-search-block" autocomplete="off">
    ...
    <table class="table table-bordered table-condensed table-hover table-center table-orange table-nowrap table-sort">
        ...
        <c:forEach items="${page.list}" var="gContest">
            <tr>
                ...
                <td><a href="${ctx}/gcontest/gContest/auditedView?gcontestId=${gContest.id}&state=${gContest.auditCode}">
                                       ${gContest.pName}</a></td>
                <td>
                ...
                <c:if test="${state!=null && state=='7'}">
                    ...
                    <td>
                        ...
                        <c:if test="${gContest.schoolendResult!=null && gContest.schoolendResult=='5'}">
                            优秀
                        </c:if>
                        <c:if test="${gContest.schoolendResult!=null && gContest.schoolendResult=='2'}">
                            三等奖
                ...
                <td>
                    ...
                    <c:if test="${state!=null && state=='4'}">
                        ...
                        <%--<c:when test="${gContest.auditCode=='4'}">--%>
                        <%--<a class="btn btn-pimray btn-small"--%>
                        <%--href="${ctx}/gcontest/gContest/auditView?gcontestId=${gContest.id}"/>--%>
                        <%--${auditName}--%>
                        <%--</a>--%>
                        <%--</c:when>--%>
                    ...
                    <c:if test="${state!=null && state=='6'}">
                        ...
                        <%-- <a class="btn btn-pimray btn-small" target="_blank"
