...
<body>
<div class="mybreadcrumbs"><span>参赛项目路演</span></div>
		<div class="content_panel">
		<ul class="nav nav-tabs"  style="margin-top: 10px;">
			<li><a href="${ctx}/gcontest/gContest/schoolActAuditList/">待审核</a></li>
			<li class="active"><a href="${ctx}/gcontest/gContest/schoolActAuditedList/">已审核</a></li>
		</ul>

	<form:form id="searchForm" modelAttribute="gContest" action="${ctx}/gcontest/gContest/schoolActAuditedList" method="post" class="breadcrumb form-search clearfix">
				...
				<td>
					<c:choose>
						<c:when test="${gContest.auditCode!=null && gContest.auditCode!='0'&& gContest.auditCode!='7' && gContest.auditCode!='8'&& gContest.auditCode!='9'}">
							...
							<a href="${ctx}/actyw/actYwGnode/designView/${gContest.auditCode}?groupId=${gContest.groupId}" class="countNum" target="_blank">${gContest.auditState}</a>
						</c:when>
						<c:otherwise>
							${gContest.auditState}
						</c:otherwise>
