...
<ul class="nav nav-tabs"  style="margin-top: 10px;">
	<li ><a href="${ctx}/state/schoolSetList/">待审核</a></li>
	<li class="active"><a href="${ctx}/state/schoolSetedList">已审核</a></li>
</ul>
<form:form id="searchForm" modelAttribute="act" action="${ctx}/state/schoolSetedList" method="post" class="breadcrumb form-search clearfix">
