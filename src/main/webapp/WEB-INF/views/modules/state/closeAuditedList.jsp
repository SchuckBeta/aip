...
<body>
	<div class="mybreadcrumbs"><span>结项审核</span></div>
	<div class="content_panel">
	<ul class="nav nav-tabs" style="margin-top: 10px;">
		<li ><a href="${ctx}/state/closeAuditList/">待审核</a></li>
		<li class="active"><a href="${ctx}/state/closeAuditedList">已审核</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="act" action="${ctx}/state/closeAuditedList" method="post" class="breadcrumb form-search clearfix">
	...
	<table id="contentTable" class="table  table-bordered table-condensed self_table">
		...
		<c:forEach items="${page.list}" var="act">
			...
			<tr>
				...
				<%--	<a class="check_btn" href="javascript:void(0)" onclick="downloadFile('${act.vars.map.id}',3)">下载结项报告</a>--%>
				</td>
			</tr>
		</c:forEach>
		</tbody>
