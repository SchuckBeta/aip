...
<script type="text/javascript">
	...
	$(document).ready(function() {
		if("${projectDeclare.midCount}"==1){
			$("#midResult option:last").remove();
		}
...
<form:form id="inputForm" modelAttribute="projectDeclare" action="${ctx}/state/secCheckSave" method="post" >
	<form:hidden path="id"/>
			...
			<div style="padding:10px" id="lastCheckToggle_wrap">
				...
				<div class="form-horizontal row" novalidate>
					<div class="form-group col-sm-6 col-md-6 col-lg-6">
						...
						<form:select path="midResult" class="input-xlarge required">
							<form:option value="" label="请选择"/>
							<form:option value="0" label="合格"/>
							<form:option value="2" label="不合格"/>
							<form:option value="4" label="需整改"/>
						</form:select>
					</div>
				</div>
				...
				<div class="row" style="text-align: center;">
					...
					<button type="button" class="btn btn-sm btn-primary" id="btnSumbit" onclick="submitCheck();" style="margin-right: 50px;">提交</button>
