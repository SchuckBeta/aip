...
<div class="container-fluid">
    ...
    <form:form id="searchForm" modelAttribute="projectDeclare" action="${ctx}/state/middleAuditList" method="post"
    ...
    <table id="contentTable" class="table table-bordered table-condensed table-hover table-center table-orange table-nowrap table-sort">
        ...
        <c:forEach items="${page.list}" var="proDeclare">
            <tr>
                <td>
                      ${proDeclare.state == "other"? projectDeclare.number :proDeclare.number} <%--${act.vars.map.number}--%>
                </td>
                <td>
                    <c:choose>
                        <c:when test="${proDeclare.state=='other'}">
                ...
                <td>
                        ${proDeclare.state == "other"?  pj:getTeamNum(proDeclare.snames) :proDeclare.snumber}
                </td>
                <td>
                ...
                <td>
                    ...
                    <c:if test="${proDeclare.state=='other'}">
                        <a class="btn btn-primary btn-small"
                           href="${ctx}/state/projectDetail?id=${proDeclare.id}">
                            查看
                        </a>
                    </c:if>
                </td>
