...
<div id="app" v-show="pageLoad" style="display: none" class="container-fluid mgb-60">
    ...
    <el-form :model="searchListForm" ref="searchListForm" size="mini">
        ...
        <div class="search-block_bar clearfix">
            <div class="search-btns">
                ...
                <el-button size="mini" type="primary" @click.stop.prevent="goAdd">添加</el-button>
            </div>
    ...
    <div class="table-container">
        <el-table :data="tableList" size="mini" class="table" ref="tableList" v-loading="loading"
            ...
            <%--<el-table-column label="归属栏目" prop="categoryId" align="center" min-width="120">--%>
                <%--<template slot-scope="scope">--%>
    ...
    new Vue({
        ...
        methods: {
            ...
            getDataList: function () {
                ...
                this.$axios({
                    method: 'POST',
                    url: '/cms/cmsArticle/homeGcontestList?' + Object.toURLSearchParams(this.searchListForm)
