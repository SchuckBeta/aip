...
<div class="container">
    ...
    <form action="/f/scoapply/saveForm" id="inputForm" style="margin-bottom: 60px;" autocomplete="off">
        ...
        <div class="credit-apply">
            ...
            <div class="form-horizontal">
                <div class="form-group">
                    <label class="control-label col-md-2" style="width: 188px;">申请课程学分认定理由：</label>
                    <div class="col-md-8" style="width: 800px; padding-left: 0">
                        <p class="reason white-space-pre">${scoApply.remarks}</p>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-2" style="width: 188px;">附件：</label>
