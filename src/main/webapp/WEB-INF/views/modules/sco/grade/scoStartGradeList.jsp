...
<div class="container-fluid">
    ...
    <form id="searchStartForm" class="form-horizontal clearfix form-search-block" modelAttribute="scoProjectVo"
          action="/a/sco/scoreGrade/startList">
    ...
    <table class="table table-bordered table-condensed table-hover table-center table-orange table-nowrap table-sort">
        ...
        <c:forEach items="${page.list}" var="scoProjectVo">
            <tr>
                ...
                <td>
                    <a href="${ctx}/sco/scoreGrade/startView?id=${scoProjectVo.scoAffirm.id}">${scoProjectVo.projectDeclare.name}</a>
                </td>
