...
<div class="container-fluid container-fluid-audit" style="margin-bottom: 60px;">
    <%--<div class="edit-bar clearfix">--%>
        <%--<div class="edit-bar-left">--%>
            <%--<span>项目变更</span> <i class="line weight-line"></i>--%>
        <%--</div>--%>
    <%--</div>--%>
        ...
        <div id="teamDetail" class="panel-body collapse in">
            <div class="panel-inner">
                <div class="control-group">
                    <label class="control-label"><i>*</i>项目编号：</label>
                    <div class="controls">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" maxlength="15" name="shortName" value="${proModel.shortName}"
                               placeholder="最多15个字符">
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <sys:frontUploaderLogo logo="${proModel.logo.url}" inputName="logoUrl" filepath="projectlogo" dir="cutImgToTempDir" logoId="${proModel.logo.id}"></sys:frontUploaderLogo>
                    </div>
                </div>
                <div class="control-group">
...
<div id="modalChangeRecord" class="modal hide" tabindex="-1" role="dialog">
