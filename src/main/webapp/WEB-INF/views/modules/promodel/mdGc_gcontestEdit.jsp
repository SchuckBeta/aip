...
<script type="text/javascript">
    ...
    $(function () {
        var teamStu = '${fns: toJson(teamStu)}';
        teamStu = teamStu.replace(/\n/g, '\\\\n').replace(/\r/g, '\\\\r');
        teamStu = JSON.parse(teamStu);

        var teamTea = '${fns: toJson(teamTea)}';
        teamTea = teamTea.replace(/\n/g, '\\\\n').replace(/\r/g, '\\\\r');
        teamTea = JSON.parse(teamTea);
