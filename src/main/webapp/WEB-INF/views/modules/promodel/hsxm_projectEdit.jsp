                    ...
                    <div class="span4">
                        ...
                        <div class="items-box">
                            <input type="text" name="competitionNumber" required
                                   id="competitionNumber" maxlength="24" value="${proModelHsxm.proModel.competitionNumber}"/>
                        </div>
                    </div>
                        ...
                        <div class="controls">
                            <select id="source" name="source" class="form-control required fill">
                                ...
                                <c:forEach items="${fns:getDictList('project_source')}" var="item">
                                    ...
                                    <c:if test="${proModelHsxm.source eq item.value}">
                                        selected = "selected"
                                    </c:if>
                                >${item.label}</option>
                                </c:forEach>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea class="input-xxlarge" style="width:87%;"
                                      name="innovation"
                                      rows="3"
                                      maxlength="2000" placeholder="最多2000个字符">${proModelHsxm.innovation}</textarea>
                        </div>
                    </div>
                                ...
                                <tr>
                                    <td>
                                        <textarea name="planContent" class="form-control required fill" rows="3" style="width:85%;"
                                                  maxlength="2000">${proModelHsxm.planContent}</textarea>
                                    </td>
                                    ...
                                    <td>
                                        <textarea name="planStep" class="form-control required fill" rows="3" style="width:85%;"
                                                  maxlength="2000">${proModelHsxm.planStep}</textarea>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <%--<input type="text" class="number form-control required" maxlength="20" style="width:45px"--%>
                                                       ...
                                                       <%--value="${proModelHsxm.planList[status.index].quality }"/>--%>
                                            </td>
                                            <td style="width:65px">
                                                <a class="minus project-minus"></a>
                                                <a class="plus"></a>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea class="required input-xxlarge" rows="3" style="width:87%;"
                                      name="resultContent"
                                      maxlength="2000">${proModelHsxm.resultContent}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea class="required input-xxlarge" rows="3" style="width:87%;"
                                      ...
                                      maxlength="2000">${proModelHsxm.budget}</textarea>
                        </div>
                    </div>
                </div>
            </div>
