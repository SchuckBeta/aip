...
//                        }
        ...
        function unresall() {
            ...
            confirmx("确定取消发布所选项目？", function () {
                resetTip();
                location.href = "${ctx}/cms/excellent/unrelease?from=gcontestList&ids=" + temarr.join(",");
            });
        }
        function deleteall() {
            var temarr = [];
            ...
            confirmx("确定删除所选项目？", function () {
                resetTip();
                location.href = "${ctx}/cms/excellent/delete?from=gcontestList&ids=" + temarr.join(",");
            });
        }
        ...
        function resetPul(id) {
            resetTip();
            location.href='${ctx}/cms/excellent/unrelease?ids='+id+'&from=gcontestList'
        }
    </script>
    <style>
...
<div class="container-fluid">
    ...
    <form:form id="searchForm" modelAttribute="vo" action="${ctx}/cms/excellent/gcontestList" method="post"
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <form:select path="type" class="input-medium">
                        ...
                        <form:options items="${fns:getDictList('competition_type')}"
                ...
                <td>
                    <shiro:hasPermission name="excellent:projectShow:edit">
                        <c:if test="${es.state=='0' }">
                            <a href="${ctx}/cms/excellent/gcontestShowForm?gcontestId=${es.foreignId}"
                        ...
                        <a href="${ctx}/cms/excellent/delete?ids=${es.id}&from=gcontestList"
