...
<div class="footerBox" style="text-align:center;  background-color: white; position: fixed; bottom: 0; left: 0; right: 0; border-top: 1px solid #ddd; z-index: 120;">
	<p class="copyright" style="margin:0">
		<%-- <c:choose>
			<c:when test="${fnc:getAutoSite().copyright != null && fnc:getAutoSite().copyright != ''}">
				...
				技术支持:武汉噢易云计算股份有限公司 <a style="font-size: 12px; color: rgb(0,0,199);text-decoration: underline" href="${fns:getSysFrontIp()}/f">进入门户网站</a>
			</c:when>
			<c:otherwise>
