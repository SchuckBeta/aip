	            ...
	            <c:forEach items="${fileitems}" var="item" varStatus="status">
	            	<li class='work'>
                        ...
                        <div class="relative accessory">
                            ...
                            <span class='date'><fmt:formatDate value="${item.createDate}" pattern="yyyy/MM/dd HH:mm:ss"/></span>
                        </div>
                    </li>
	            </c:forEach>
	        </ul>
