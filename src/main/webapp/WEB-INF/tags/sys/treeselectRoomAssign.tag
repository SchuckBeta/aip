                ...
                "选择${title}", 320, 420, {
                    ...
                    submit: function (v, h, f) {
                        if (v == "ok") {
                            ...
                            {
                                var assignedXhr = $.post('${ctx}/pw/pwEnter/treeData?status=3,4,6&rids='+roomId);
                                assignedXhr.success(function (data) {
                                    ...
                                    data.forEach(function (t, i) {
                                        var teamName = t.data.eteam ? t.data.eteam.team.name : '-';
                                        var companyName = t.data.ecompany ? t.data.ecompany.pwCompany.name : '-';
                                        var proName = t.data.eproject ? t.data.eproject.project.name : '-';
                                        if (teamName) {
//                                            console.log(t.data.endDate);
                                            var endDate = t.data.endDate.substring(0, 10);
                                            console.log(endDate);
                                            trs += '<tr data-index="' + i + '"><td>' + (i + 1) + '</td><td>' + t.name + '</td><td><span class="team-name">' + teamName + " / " + companyName + " / " + proName + '</span></td><td>' + t.data.applicant.name + '</td><td>' + endDate + '</td></tr>'
                                        }
                                    });
