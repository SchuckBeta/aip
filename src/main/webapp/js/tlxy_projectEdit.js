...
var tlxy = {
    ...
    tabletrminus: function () {
        $(".project-minus").unbind();
        $(".project-minus").click(function () {
    ...
    tabletrplus: function () {
        ...
        $(".plus").click(function () {
            ...
            var html = '<tr>'
                ...
                + '</td>'
                + '<td>'
                + '	<textarea name="planList[' + tlxy.plansIndex + '].content" required maxlength="2000" class="form-control" style="width:120px;" rows="3"></textarea>'
                + '</td>'
                + '<td>'
                + '	<textarea name="planList[' + tlxy.plansIndex + '].description" required maxlength="2000" class="form-control" style="width:120px;" rows="3"></textarea>'
                + '</td>'
                + '<td class="timeerrorbox">'
                + '	<input id="plan-start-date-'+tlxy.plansIndex + '" class="Wdate date-input required" readonly="readonly" style="width: 100px;" type="text" name="planList[' + tlxy.plansIndex + '].startDate" onClick="WdatePicker()"/>'
                + '	<span>至</span>'
                + '	<input id="plan-end-date-'+tlxy.plansIndex + '" class="Wdate date-input required" readonly="readonly" style="width: 100px;" type="text" name="planList[' + tlxy.plansIndex + '].endDate"  onClick="WdatePicker({dateFmt:\'yyyy-MM-dd\',isShowClear:true,minDate:$(\'#plan-start-date-'+tlxy.plansIndex + '\').val()})"/>'
                + '</td>'
                + '<td>'
                + '	<input type="number" name="planList[' + tlxy.plansIndex + '].cost" style="width:45px;" class="number form-control required" maxlength="20" />'
                + '</td>'
                + '<td>'
                + '	<textarea name="planList[' + tlxy.plansIndex + '].quality" rows="3" style="width:120px;" class="form-control required" maxlength="2000"></textarea>'
                + '</td>'
                + '<td style="width:65px;">'
