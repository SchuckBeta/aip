...
function checkOnInit(){
	...
	if(currState == 2){
		showModalMessage(0, "您已经毕业，不能申报项目", {
			确定: function() {
				top.location = "/f";
			},
			取消: function() {
...
+'								</td>'
+'								<td>'
+'									<textarea required name="plans['+GCSB.plansIndex+'].content" class="form-control" maxlength="502" rows="3"></textarea>'
+'								</td>'
+'								<td>'
+'									<textarea required name="plans['+GCSB.plansIndex+'].description" class="form-control" maxlength="1024" rows="3"></textarea>'
+'								</td>'
...
+'								</td>'
+'								<td>'
+'									<textarea required class="form-control" rows="3" maxlength="20" name="plans['+GCSB.plansIndex+'].quality"></textarea>'
+'								</td>'
+'								<td>'
+'									<a class="minus"></a>'
+'									<a class="plus"></a>'
