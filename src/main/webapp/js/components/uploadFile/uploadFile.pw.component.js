...
Vue.component('e-pw-upload-file', {
    ...
    '<input v-if="false" v-for="item in nInputsHidden" type="hidden" :name="item"  :value="file[item]"> ' +
    '<template v-if="!file.viewUrl"><div class="ufl-layer" v-if="(file.status != \'success\'&& file.uid && !file.id)"> <img src="/images/loading.gif"> </div></template> </div> </div> ' +
